...
const Navbar = () => {
  return (
    <Disclosure as="nav" className="bg-white">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-5xl lg:px-20 sm:px-6 border-b border-gray-300">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <h1 className="font-bold text-lg">Sneakers</h1>
                </div>
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-gray-300 hover:text-black hover:underline underline-offset-8 decoration-4 decoration-[#FF7D1A] decoration-solid sm:text-lg",
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3 ">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF7D1A] focus:ring-offset-2 focus:ring-offset-[#FF7D1A]">
                      <span className="absolute -inset-1.5" />
